...
#img_cross = cv2.imread("C:/UIT-Courses/CE410.Q11 - Computer System Engineering/New folder/MIS.jpg")
...
def main():
	...
	global polygon_points, final_polygon, detected_lp_set
	polygon_points = []
	final_polygon = False
	detected_lp_set = set()
    # -------------------------------------------------------------------
					...
					if inside:
						...
						for result in lp_results:
							...
							for box in xyxy:
								...
								cv2.rectangle(img_lp, (x1, y1), (x2, y2), (0, 0, 225), 2)
